...
export const metadata: Metadata = {
  ...
  description: 'First-party browser storage used by the current ByteSized Careers early-access registration programme.',
  alternates: { canonical: '/early-access/cookies' },
  openGraph: {
    title: 'Early Access Storage Notice | ByteSized Careers',
    description: 'Storage and cookie information for the current ByteSized Careers early-access registration programme.',
    url: '/early-access/cookies',
    type: 'website',
  },
  twitter: {
  ...
  return (
    ...
    >
      <LegalCallout title="Current scope and consent conclusion">
        ...
        <p>
          This notice applies only to the current early-access registration and restricted administration
          experience and the storage used by them. Storage for future marketplace accounts and features will require a separate or
          updated notice before those features launch.
        </p>
      </LegalCallout>
      ...
      <LegalSection number="03" title="Your controls">
        ...
        <p>
          ...
          or deletion, follow the process in the <Link href="/early-access/privacy">Privacy Notice</Link>.
        </p>
      </LegalSection>
