...
export const metadata: Metadata = {
  title: 'Privacy notice · ByteSized Careers',
  description: 'How the ByteSized Careers early-access website handles personal information.',
};
...
export default function PrivacyPage() {
  return (
    <LegalPage
      ...
      title="Your brief is personal. Here is its paper trail."
    ...
    >
      ...
      <LegalSection number="08" title="Browser storage and cookies">
        ...
        <p>
          ...
          <Link href="/cookies">Cookie &amp; storage notice</Link> for the detailed table and browser controls.
        </p>
      </LegalSection>
