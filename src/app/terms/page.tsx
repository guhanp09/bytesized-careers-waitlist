...
export const metadata: Metadata = {
  title: 'Early-access terms · ByteSized Careers',
  description: 'Terms for the ByteSized Careers pre-launch early-access registration website.',
};
...
export default function TermsPage() {
  return (
    <LegalPage
      ...
      title="Terms for the waiting room—not a marketplace that has launched."
    ...
    >
      ...
      <LegalSection number="01" title="Operator and agreement">
        ...
        <p>
          ...
          the <Link href="/privacy">Privacy Notice</Link>. If you do not agree, do not submit the form. Mandatory
      ...
      <LegalSection number="09" title="Communications and privacy">
        ...
        <p>
          ...
          matching and phone outreach are not active today. See the <Link href="/privacy">Privacy Notice</Link> and{' '}
          <Link href="/cookies">Cookie &amp; storage notice</Link>.
        </p>
      </LegalSection>
